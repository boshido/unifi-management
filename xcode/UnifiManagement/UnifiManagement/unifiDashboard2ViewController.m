...
#import "unifiDashboard2ViewController.h"
#import "unifiApResource.h"
#import "unifiDeviceResource.h"
#import "DejalActivityView.h"

@interface unifiDashboard2ViewController ()

@end

@implementation unifiDashboard2ViewController
...
-(void)loadDashBoardInfo{
    ...
    ApiCompleteCallback deviceCallback = ^(NSJSONSerialization *responseJSON,NSString * responseNSString){
        ...
        devicePercentage = (authorized/(authorized+non_authorized))*100;
         flag2 = YES;
        if(flag1 && flag2 && flag3){
            completeAll();
        }
